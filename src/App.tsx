              ...
              >
                ...
                <div className="flex gap-2 relative z-50">
                  ...
                  <button 
                    ...
                    className="w-12 flex items-center justify-center bg-white/5 hover:bg-rose-500/20 hover:text-rose-500 text-zinc-500 rounded-xl transition-all border border-white/5"
                  >
      ...
      <footer className="max-w-7xl mx-auto px-6 py-10 border-t border-white/5 mt-10">
        <div className="flex flex-col md:flex-row justify-between items-center gap-6">
          ...
          <div className="text-[10px] text-zinc-700 font-mono">
            MORT ROYAL BOT v2.0.4 // DESIGNED FOR DOMINATION
          </div>
